import { doc, getDoc, collection, onSnapshot, addDoc, getDocs } from 'firebase/firestore';
    ...
    <div className=' mt-10'>
      <div className=' bg-gray-200 py-4'>
        ...
        <div className='w-[100%] h-[30rem] '>
          <img src={blog?.imgUrl} alt="image" className=' w-[100%] h-[100%]' />
          <div className='absolute bottom-24 left-[40%] w-[20rem] h-[5rem] mx-auto bg-black opacity-50 text-white'>
        ...
        <div className=' flex'>
          <div className=' w-[80%] ml-[3rem] mx-[1rem] my-[2rem]'>
            <h1 className=' text-4xl text-left ml-10 font-sans font-normal my-5'>{blog?.title}</h1>
            
            <div className='flex justify-between mx-10 border-b-2 border-black mb-4'>
            ...
            <p className=' text-left mx-10 font-sans text-lg overflow-hidden' dangerouslySetInnerHTML={{ __html: blog?.blog }}></p>
